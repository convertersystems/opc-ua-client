...
namespace Workstation.ServiceModel.Ua.Channels
{
    ...
    internal class ObjectPool<T>
        where T : class
    {
        private static readonly MetroLog.ILogger Log = MetroLog.LogManagerFactory.DefaultLogManager.GetLogger<ObjectPool<T>>();
        ...
        private class LeakTracker : IDisposable
        {
            ...
            ~LeakTracker()
            {
                if (!this.disposed && !Environment.HasShutdownStarted)
                {
                    ...
                    ObjectPool<T>.Log.Warn($"TRACEOBJECTPOOLLEAKS_BEGIN\nPool detected potential leaking of {typeof(T)}. \n Location of the leak: \n {this.GetTrace()} TRACEOBJECTPOOLLEAKS_END");
                }
            }
        }
#endif
        ...
        internal void ForgetTrackedObject(T old, T replacement = null)
        {
            ...
            else
            {
                ...
                Log.Warn($"TRACEOBJECTPOOLLEAKS_BEGIN\nObject of type {typeof(T)} was freed, but was not from pool. \n Callstack: \n {trace} TRACEOBJECTPOOLLEAKS_END");
            }
